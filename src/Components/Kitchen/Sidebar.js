                ...
                <ul className="font-semibold w-full mx-auto flex flex-col justify-center items-start space-y-3 text-xl">
                    <li className="w-full">
                        <button 
                            ...
                            className={`flex items-center w-full p-2 pl-10 hover:bg-[#d52a2a] text-left ${
                                location.pathname === '/dashboard' ? 'bg-[#d52a2a]' : ''
                            }`}
                        >
                    ...
                    <li className="w-full">
                        <button 
                            ...
                            className={`flex items-center w-full p-2 pl-10 hover:bg-[#d52a2a] text-left ${
                                location.pathname === '/order' ? 'bg-[#d52a2a]' : ''
                            }`}
                        >
                    ...
                    <li className="w-full">
                        <button 
                            ...
                            className={`flex items-center w-full p-2 pl-10 hover:bg-[#d52a2a] text-left ${
                                location.pathname === '/menu' ? 'bg-[#d52a2a]' : ''
                            }`}
                        >
                    ...
                    <li className="w-full">
                        <button 
                            ...
                            className={`flex items-center w-full p-2 pl-10 hover:bg-[#d52a2a] text-left ${
                                location.pathname === '/grocery' ? 'bg-[#d52a2a]' : ''
                            }`}
                        >
                    ...
                    <li className="w-full">
                        <button 
                            ...
                            className={`flex items-center w-full p-2 pl-10 hover:bg-[#d52a2a] text-left ${
                                location.pathname === '/notes' ? 'bg-[#d52a2a]' : ''
                            }`}
                        >
                    ...
                    <li className="w-full">
                        <button 
                            ...
                            className={`flex items-center w-full p-2 pl-10 hover:bg-[#d52a2a] text-left ${
                                location.pathname === '/notifications' ? 'bg-[#d52a2a]' : ''
                            }`}
                        >
                    ...
                    <li className="w-full">
                        <button 
                            ...
                            className={`flex items-center w-full p-2 pl-10 hover:bg-[#d52a2a] text-left ${
                                location.pathname === '/online-orders' ? 'bg-[#d52a2a]' : ''
                            }`}
                        >
                    ...
                    {/* Divider */}
                    <div className="w-4/5 justify-end border-t border-white my-4 mx-auto"></div>
