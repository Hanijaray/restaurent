...
const Popup = ({ onClose, onTakeOrder }) => {
  return (
    <div className="fixed inset-0 flex justify-center items-center bg-black bg-opacity-50 shadow-2xl-black-500/50">
      <div className="bg-white p-10 w-[500px] rounded-xl">
        <h1 className="text-4xl text-center font-semibold mb-2 font-serif">Take your Order</h1>
        <p className="mb-4 text-center text-sm">Are you sure you want to take this order?</p>
        ...
        <div className="flex items-center mb-8 border rounded-xl w-[400px]">
          ...
          <span className="font-bold text-xl">
            Alban Santhosh
            <p className="font-normal text-sm">Main chef</p>
          </span>
        </div>
